      ...
      <div className="relative z-10 max-w-6xl w-full px-6 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-6 text-lg md:text-xl text-slate-600 leading-relaxed max-w-lg mx-auto md:mx-0">
            ...
            <span className="font-semibold"> “IIITian”</span>.
          </p>

          <div className="mt-8 flex justify-center md:justify-start gap-5">
            <button className="px-6 py-3 rounded-lg bg-indigo-600 text-white text-lg font-semibold hover:bg-indigo-700 transition">
              Explore
            </button>
            <button className="px-6 py-3 rounded-lg border border-indigo-600 text-indigo-600 text-lg font-semibold hover:bg-indigo-50 transition">
              Back
            </button>
          </div>
        </div>
