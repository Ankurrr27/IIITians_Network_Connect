...
function AccountCard({ account, index, isPrimary, savingId, updateAccount, deleteAccount }) {
  const [isFormOpen, setIsFormOpen] = useState(false);

  return (
    <div className="relative overflow-hidden rounded-[1.8rem] border border-slate-200 bg-white p-0 shadow-sm transition-all">
      {/* Card Header (Contact Info) */}
      <div 
        className="bg-slate-50/50 p-6 cursor-pointer hover:bg-slate-100/50 transition-colors"
      ...
      >
        ...
        <div className="mt-4 flex items-center justify-center border-t border-slate-200/60 pt-3 opacity-60">
          <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500 flex items-center gap-1 group-hover:text-indigo-600">
             {isFormOpen ? "Close Admin Data" : "View & Edit Admin Data"}
